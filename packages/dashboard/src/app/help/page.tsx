  ...
  return (
    <div style={{ background: "#0a0a0c", color: "#e8e8ed", minHeight: "100vh", fontFamily: "system-ui, -apple-system, sans-serif" }}>
      <nav style={{ padding: "16px 32px", borderBottom: "1px solid #2a2a33", display: "flex", gap: 24 }}>
        ...
        <Link href="/status" style={{ color: "#8888a0", fontFamily: "monospace", fontSize: 13, textDecoration: "none" }}>Status</Link>
        <Link href="/blog" style={{ color: "#8888a0", fontFamily: "monospace", fontSize: 13, textDecoration: "none" }}>Blog</Link>
      </nav>
