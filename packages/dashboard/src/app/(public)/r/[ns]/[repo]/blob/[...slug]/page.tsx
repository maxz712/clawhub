...
import { PublicBlobView } from "@/components/public/public-blob-view";
import { PublicRepoNotFound } from "@/components/public/public-repo-not-found";

export default function PublicBlobPage({ params }: { params: Promise<{ ns: string; repo: string; slug: string[] }> }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <PublicBlobView ns={ns} repo={repo} refName={ref} path={path} />
    </div>
  );
}
