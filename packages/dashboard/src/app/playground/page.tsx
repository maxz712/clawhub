  ...
  return (
    <div style={{ background: "#0a0a0c", color: "#e8e8ed", minHeight: "100vh", fontFamily: "system-ui, -apple-system, sans-serif" }}>
      <nav style={{ padding: "16px 32px", borderBottom: "1px solid #2a2a33", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <Link href="/register" style={{ fontFamily: "monospace", fontSize: 13, background: "#00e5a0", color: "#0a0a0c", padding: "6px 14px", borderRadius: 6, textDecoration: "none", fontWeight: 600 }}>Sign up →</Link>
      </nav>

      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "60px 24px" }}>
        <div style={{ fontFamily: "monospace", color: "#00e5a0", fontSize: 12, textTransform: "uppercase", letterSpacing: 3, marginBottom: 12 }}>Playground</div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 24 }}>
          <div>
            ...
            <textarea value={commitMessage} onChange={e => setCommitMessage(e.target.value)} rows={12}
              style={{ width: "100%", fontFamily: "monospace", fontSize: 13, background: "#16161b", color: "#e8e8ed", border: "1px solid #2a2a33", borderRadius: 8, padding: 12 }} />
          </div>
          <div>
        ...
        <button onClick={run} disabled={loading}
          style={{ background: "#00e5a0", color: "#0a0a0c", padding: "12px 28px", border: "none", borderRadius: 8, fontWeight: 700, cursor: "pointer", fontFamily: "system-ui, -apple-system, sans-serif" }}>
        ...
        {result && (
          <>
            ...
            <div style={{ marginTop: 24, background: "#16161b", border: "1px solid #2a2a33", borderRadius: 10, padding: 20, fontFamily: "monospace", fontSize: 13 }}>
            ...
            <div style={{ marginTop: 24, background: "#16161b", border: "1px solid #00e5a0", borderRadius: 10, padding: 20 }}>
              <div style={{ color: "#00e5a0", textTransform: "uppercase", letterSpacing: 2, fontSize: 11, marginBottom: 8, fontFamily: "monospace" }}>Focused diff</div>
              <pre style={{ fontFamily: "monospace", fontSize: 13, color: "#e8e8ed", margin: 0, whiteSpace: "pre-wrap" }}>{result.focused || "(no flagged lines found)"}</pre>
            </div>
          </>
        )}
      </div>
...
function Label({ children }: { children: React.ReactNode }) {
  return <div style={{ fontSize: 12, color: "#8888a0", marginBottom: 6, fontFamily: "monospace", textTransform: "uppercase", letterSpacing: 1 }}>{children}</div>;
}
