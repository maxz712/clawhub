    ...
    <div style={{ background: "#0a0a0c", color: "#e8e8ed", minHeight: "100vh", fontFamily: "system-ui, -apple-system, sans-serif" }}>
      <nav style={{ padding: "16px 32px", borderBottom: "1px solid #2a2a33", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <div style={{ display: "flex", gap: 24 }}>
          ...
          <Link href="/changelog" style={{ color: "#8888a0", fontFamily: "monospace", fontSize: 13, textDecoration: "none" }}>Changelog</Link>
        </div>
      </nav>

      <div style={{ maxWidth: 1000, margin: "0 auto", padding: "60px 24px" }}>
        <div style={{ fontFamily: "monospace", color: "#00e5a0", fontSize: 12, textTransform: "uppercase", letterSpacing: 3, marginBottom: 12 }}>Explore</div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          {rows.map(r => (
            <div key={r.id} style={{ background: "#16161b", border: "1px solid #2a2a33", borderRadius: 10, padding: 18, display: "grid", gridTemplateColumns: "1fr auto auto", alignItems: "center", gap: 24 }}>
              ...
              <div style={{ textAlign: "right", fontFamily: "monospace", fontSize: 13, color: "#8888a0" }}>
                <div>★ {r.stars.toLocaleString()}</div>
                <div>{r.changesThisWeek} changes/wk</div>
              </div>
              <div style={{ fontFamily: "monospace", fontSize: 11, color: "#00e5a0" }}>
