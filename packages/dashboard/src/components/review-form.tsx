...
export function ReviewForm({ ns, repo, changeId, onSubmitted }: { ns: string; repo: string; changeId: string; onSubmitted: () => void }) {
  ...
  return (
    <form onSubmit={submit} className="space-y-3">
      ...
      <div>
        <Label className="text-xs font-mono uppercase text-muted-foreground">Verdict</Label>
      ...
      <div>
        <Label htmlFor="summary" className="text-xs font-mono uppercase text-muted-foreground">Summary</Label>
