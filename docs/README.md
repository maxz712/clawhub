...
| [`review-overhaul-strategy.md`](review-overhaul-strategy.md) + [`review-overhaul-plan.md`](review-overhaul-plan.md) | **The direction + its as-built record — single source of truth**: "inference informs, determinism decides", decisions D1–D10, the nine Q3 milestones and the Q4 items (ALL BUILT — read the plan's as-built status block), and the 2027–2028 horizon with pre-committed pivot triggers |
